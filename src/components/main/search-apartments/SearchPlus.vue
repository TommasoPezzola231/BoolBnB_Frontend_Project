...
<div class="modal fade modal-overlay" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
.modal-overlay {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(5, 5, 5, 0.788);
    display: flex;
